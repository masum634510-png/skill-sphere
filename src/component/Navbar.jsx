...
const Navbar = () => {
    ...
    return (
        <div className="navbar bg-base-100 px-4 shadow-sm sticky top-0 z-50">
            <div className="navbar-start">
                ...
                <Link href="/" className="flex items-center gap-1">
                    <Image src="/2.png" alt="SkillSphere Logo" width={40} height={40} priority />
            ...
            <div className="navbar-end gap-2">
                {isPending ? (
                    ...
                    <div className="dropdown dropdown-end">
                        ...
                        <ul tabIndex={0} className="dropdown-content menu bg-base-100 rounded-box z-[999] w-48 p-2 shadow mt-2">
                    ...
                    <>
                        <Link href="/login" className="font-medium hover:text-orange-600 text-sm">Login</Link>
                        <Link href="/register" className="btn btn-sm bg-orange-500 hover:bg-orange-600 text-white text-xs px-3">Register</Link>
                    </>
                )}
            </div>
        </div>
