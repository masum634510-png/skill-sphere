...
const Footer = () => {
    return (
        <footer className="relative mt-24 bg-gray-50 dark:bg-[#0a0a0b] border-t">
            <div className="max-w-7xl mx-auto px-6 py-16">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-12">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-sm leading-relaxed text-gray-600 dark:text-gray-400">
                            A modern online learning platform to explore courses, watch lessons, and enroll in skill-based programs.
                        </p>
                    </div>
                    <div>
                ...
                <div className="mt-12 h-px w-full bg-gray-300 dark:bg-white/10" />

                <div className="mt-6 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-gray-500 dark:text-gray-400">
                    <p>© {new Date().getFullYear()} SkillSphere. All rights reserved.</p>
                    <p>Built with ❤️ by Md Masum Billah</p>
                </div>
            </div>
        </footer>
    );
